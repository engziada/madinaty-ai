...
export function CourseFaqPage({ locale }: CourseFaqPageProps) {
  ...
  const t = {
    ...
    policyTextsAr: [
      ...
      "الرسوم (٤٤٩٫٩٩ ج.م) غير مستردة في حالة الغياب بدون إشعار مسبق قبل الموعد بـ ٤٨ ساعة."
    ],
    policyTextsEn: [
      ...
      "The reservation fee (449.99 EGP) is non-refundable for no-shows without 48-hour prior notice."
    ],
    faqsAr: [
      {
        q: "هل الكورس مجاني بالكامل؟",
        a: "نقدم حالياً خصم المونديال بنسبة ٢٠٪ لتكون التكلفة ٤٤٩٫٩٩ ج.م بدلاً من السعر الكامل. العرض متاح للجميع ومستمر حتى نهاية شهر يونيو وطوال فترة مشاركة مصر في المونديال! 🏆⚽"
      },
      {
    ...
    faqsEn: [
      {
        ...
        a: "We are currently offering a 20% World Cup discount, making the price 449.99 EGP. This offer is available for everyone and lasts until the end of June and as long as Egypt is in the World Cup! 🏆⚽"
      },
      {
