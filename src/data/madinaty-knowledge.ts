...
const knowledgeBase: Record<LocaleCode, string[]> = {
  ...
  ar: [
    ...
    "شات الذكاء الاصطناعي للأطفال: جلسة ساعتان في مركز Triple A Education Center، الدور الثاني، إيست هب، مدينتي. السعر ٤٥٠ ج.م (مخفض من ٥٦٩.٩٩ ج.م). بحد أقصى ١٠ أطفال في الجلسة. يغطي أساسيات الذكاء الاصطناعي، كتابة الأوامر الآمنة، الأمان الرقمي، والتفكير النقدي. بإشراف أساتذة من جامعة القاهرة. رابط الكورس: /ar/course/kids-session",
    "مبادئ البرمجة وتصميم الألعاب للأطفال: كورس ٦ أسابيع (إجمالي ١٢ ساعة، جلستان أسبوعياً). السعر ١٨٠٠ ج.م. يصمم الأطفال ألعابهم الخاصة وقصصاً تفاعلية. يتطلب إحضار لابتوب خاص. رابط الكورس: /ar/course/kids-ai-dev",
    "بايثون وذكاء اصطناعي: برنامج من ٣ مستويات (٨ أسابيع، ٢٤ ساعة). السعر ٥١٠٠ ج.م. من أساسيات بايثون إلى بناء نموذج ذكاء اصطناعي للتعرف على الوجوه. يتطلب إحضار لابتوب خاص. رابط الكورس: /ar/course/python-ai-programming",
    "الروبوتات والأنظمة الذكية: برنامج من ٣ مستويات (٨ أسابيع، ٢٤ ساعة). السعر ٦٢٠٠ ج.م. إلكترونيات، برمجة أردوينو، وبناء روبوت يتجنب العقبات. تدريب عملي ١٠٠٪ على الهاردوير. رابط الكورس: /ar/course/robotics-smart-systems",
    "القيادة بالذكاء الاصطناعي (للمديرين والقادة): تدريب تنفيذي مكثف ليوم واحد (٩ ساعات). السعر ٤٠٠٠ ج.م. تدريب بدون كود يغطي هندسة الأوامر (Prompt Engineering)، التفكير الاستراتيجي، تحليل القرارات، وبناء مستشار شخصي ذكي. يشمل شهادة AI Pilot معتمدة. رابط الكورس: /ar/course/ai-pilot-day",
