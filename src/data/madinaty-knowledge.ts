...
const knowledgeBase: Record<LocaleCode, string[]> = {
  en: [
    ...
    "The Community Innovation Hub in District B5 (specifically Triple A Education Center, 2nd floor, East Hub) hosts free certified AI-for-Kids courses, robotics labs, and programming workshops each weekend. Wave 1 & 2 (June 6 & 13) were fully booked; Wave 3 is scheduled for Saturday, June 20 at 12:00 PM.",
    ...
    "The AI for Kids courses are certified, with a 20% World Cup discount price of 449.99 EGP valid through June and while Egypt is playing in the tournament. They are for ages 8-12, last 2 hours, and are taught by Cairo University computer science professors and software engineers. Parents do not attend the session.",
  ...
  ar: [
    ...
    "مركز الابتكار في حي B5 (تحديداً مركز Triple A Education Center بالدور الثاني في إيست هب) يحتضن ورش وجلسات مجانية معتمدة للذكاء الاصطناعي للأطفال، ومختبرات الروبوتات كل عطلة نهاية أسبوع. الموجتان الأولى والثانية (٦ و ١٣ يونيو) كانتا كاملتي العدد؛ الموجة الثالثة مقررة يوم السبت ٢٠ يونيو الساعة ١٢ ظهراً.",
    ...
    "كورسات الذكاء الاصطناعي للأطفال معتمدة مع خصم المونديال ٢٠٪ (٤٤٩٫٩٩ ج.م) مستمر لآخر يونيو وطول ما مصر بتلعب في المونديال. الكورسات للأعمار من ٨-١٢ سنة، ومدة الجلسة ساعتان، ويقوم بالتدريس أساتذة من جامعة القاهرة ومهندسو برمجيات. الحضور يكون بدون أولياء الأمور.",
